                ...
                <div className={'col-span-12 md:col-span-6'}>
                    <div className={'h-full w-full laptop:pl-8 px-4 my-8 tablet:my-14'}>
                        <m.div variants={animationStore.staggerShort}
                            ...
                            <m.h2 variants={animationStore.loadOpacityWithXAngle} className={'text-2xl font-bold text-skin-theme-font-100'}>Create a account</m.h2>
                            {/* Google and Apple Sign In Buttons*/}
                            <div className={'flex flex-row justify-between text-xs desktop:text-sm font-semibold gap-8 smPhone:gap-4'}>
                                <m.button
                            ...
                            <m.div
                                ...
                                <div className={'border-b-[1.25px] rounded-2xl border-skin-theme-body-300/70 w-full h-1 '}></div>
                            ...
                            <form>
                                <div className={'flex flex-col gap-5 justify-start'}>
                                    ...
                                    <input
                                      type="text" placeholder={'Email'} className={'px-3 w-full h-10 rounded-lg border border-skin-theme-body-300 bg-skin-theme-body-100 focus:outline-none'}/>
                                    </m.div>
                                    <m.div variants={animationStore.loadOpacityWithYAngle}>
                                    <input
                                    ...
                                    <m.button
                                        ...
                                        className={'rounded-lg w-full py-3 bg-skin-theme-400 ring-1 ring-skin-theme-600/40 text-skin-theme-font-900 text-lg laptop:text-xl font-semibold'}>
                                        Create your new account
                                    </m.button>
                                    <m.p
                                        variants={animationStore.loadOpacityWithXAngleShort}
                                        className={'text-xs lgPhone:text-sm text-center'}>
                                        Do you have account already? <Link href={'/signin'} className={'font-bold text-skin-theme-400'}>Sign
                                        in here</Link></m.p>
                                </div>
                            </form>
                        </m.div>
